...
class Ingresar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FondoLogin(
      primario: const Color(0xff072734),
      secundario: const Color(0xff072734),
...
class _LoginForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      ...
      child: Column(
        children: [
          const Text("LOGIN", style: TextStyle(color: Color(0xff072734),fontSize: 23,fontWeight: FontWeight.bold)),
          TextFormField(
            autocorrect: false,
